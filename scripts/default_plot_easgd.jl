...
draw(PNG(string(figures_path, file_suffix, ".png"), 20cm, 15cm), plot_avgparams)
draw(PNG(string(figures_path, file_suffix, "_zoomed.png"), 20cm, 15cm), plot_avgparams_zoomed)
println("$((time() - start_time)/60) minutes\n")